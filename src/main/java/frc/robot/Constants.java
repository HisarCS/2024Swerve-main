...
public final class Constants {
  public static class IOConstants {
    public static final int DRIVER_CONTROLLER_PORT = 0; //Değişilsin
    public static final int OP_CONTROLLER_PORT = 1; // Değişilsin
  }

  public static final class SwerveConstants{
    //Drivetrain motor/encoder IDs
    public static final int LEFT_FRONT_DRIVE_ID = 1;
    public static final int RIGHT_FRONT_DRIVE_ID = 7;
    ...
    public static final int LEFT_FRONT_CANCODER_ID = 10;
    public static final int RIGHT_FRONT_CANCODER_ID = 9;
    public static final int LEFT_BACK_CANCODER_ID = 12;
    public static final int RIGHT_BACK_CANCODER_ID = 11;

    public static final int PIGEON_ID = 13; //Değişilsin

    //Drivetrain characteristics
    public static final double LEFT_FRONT_OFFSET = 0; //Değişilsin
    public static final double RIGHT_FRONT_OFFSET = 0; //Değişilsin
    public static final double LEFT_BACK_OFFSET = 0; //Değişilsin
    public static final double RIGHT_BACK_OFFSET = 180; // Değişilsin
